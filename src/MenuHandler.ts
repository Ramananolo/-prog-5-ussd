...
export class MenuHandler {
  ...
  static async handleMainMenu(input: string, rl: readline.Interface): Promise<void> {
    switch (input) {
      case "1":
  ...
  private static async showMvolaMenu(rl: readline.Interface): Promise<void> {
    let currentPage = 1;
  ...
  private static async showCreditOfferMenu(rl: readline.Interface): Promise<void> {
  ...
  private static async retraitArgent(rl: readline.Interface): Promise<void> {
  ...
  private static async acheterCreditPourMoi(rl: readline.Interface): Promise<void> {
  ...
  private static async transferVersDestination(rl: readline.Interface): Promise<void> {
  ...
  private static async acheterCreditPourAutreNumero(rl: readline.Interface): Promise<void> {
    rl.question("Entrez le numéro du destinataire : ", (numero) => {
